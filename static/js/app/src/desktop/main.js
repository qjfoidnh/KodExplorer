...
define("app/src/desktop/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "../../common/taskTap", "../../common/core", "../../common/tpl/upload.html", "../../common/tpl/formMake.html", "../../common/core.tools", "../../common/core.upload", "../../common/core.api", "../../common/core.playSound", "../../common/core.formMake", "../../common/rightMenuExtence", "../../app/appBase", "../../app/editor", "../../app/openWith", "../../app/html", "../../common/tpl/copyright.html", "../../common/tpl/themeDIY.html", "../../common/rightMenu", "../explorer/ui", "../explorer/fileContent", "../../path/tpl/file/list.html", "../../path/path", "../../path/pathOperate", "../../path/tpl/share.html", "../../path/tpl/fileinfo/fileInfo.html", "../../path/tpl/fileinfo/pathInfo.html", "../../path/tpl/fileinfo/pathInfoMore.html", "../../path/tpl/appEdit.html", "../../path/clipboard", "../../path/search", "../../path/tpl/search.html", "../../path/tpl/searchList.html", "../../path/tpl/file/create.html", "../explorer/fileLight", "../explorer/fileSelect", "../explorer/fileListResize", "../explorer/options"],
function(a, b, c) {
	Config = {
	...
	$(document).ready(function() {
		...
		a.async("lib/webuploader/webuploader-min",
		function() {
			core.uploadInit()
		}),
		...
		function() {
			...
			var a = function(a) {
				...
				$.get(G.appHost + "explorer/mkdir&repeat_type=replace&path=" + b,
				function() {
...
define("app/src/explorer/ui", ["./fileContent", "../../path/tpl/file/list.html"],
function(a, b) {
	var c = a("./fileContent"),
	d = c.f5,
	e = c.f5Callback,
	f = function(a) {
		...
		$(Config.FileBoxSelector).removeClass("file-list-icon file-list-list file-list-split"),
		"list" == a ? ($(Config.FileBoxSelector).addClass("file-list-list"), $("#list-type-header").removeClass("hidden"), ui.fileListResize.bindHeaderResize()) : "icon" == a ? ($(Config.FileBoxSelector).addClass("file-list-icon"), $(".set-icon-size").show(), $(".set-file-icon-size").show()) : "split" == a && ($(Config.FileBoxSelector).addClass("file-list-split"), $(".line-split-box").removeClass("hidden")),
		...
		"list" == a && (b += 26),
		$(".frame-header").is(":visible") && (b += $(".frame-header").outerHeight()),
		$(".bodymain").css("top", b)
	},
	g = function(a) {
		f(a),
		d(!1, !1),
		"undefined" == typeof G.sid && $.get(G.appHost + "setting/set&k=listType&v=" + a)
	},
	h = function(a, b) {
		0 != a ? (G.userConfig.listSortField = a, $(".menu-set-sort").removeClass("selected"), $(".set-sort-" + a).addClass("selected")) : a = G.userConfig.listSortField,
		0 != b ? (G.userConfig.listSortOrder = b, $(".menu-set-desc").removeClass("selected"), $(".set-sort-" + b).addClass("selected")) : b = G.userConfig.listSortOrder,
	...
	i = function() {
		$(".menu-recycle-button").bind("mouseenter",
		function(a) {
	...
	j = function() {
		$("#main-title div").die("click").live("click",
		function() {
			...
			$.ajax({
				...
				success: function(a) {
					if (!a.code) {
						...
						core.authCheck("setting.set") || (b = LNG.config_save_error_auth),
						Tips.tips(b, !1)
					}
				}
			})
	...
	m = function() {
		...
		$(".toolbar-path-more").die("click").live("click",
		function(a) {
			if ($(this).hasClass("active")) return $(".menu-tool-path").trigger("contextmenu:hide"),
		...
		$(".tool-path-newfile,.tool-path-upload").die("click").live("click",
		function(a) {
			var b = $(this).offset();
			$(this).contextMenu({
				x: b.left - 4,
	...
	s = function() {
		r(),
		Mousetrap.bind(["f1", "alt+left", "backspace", "alt+right", "ctrl+backspace", "command+backspace", "ctrl+shift+r", "f5", "left", "up", "right", "down", "home", "end", "shift+left", "shift+up", "shift+right", "shift+down", "shift+home", "shift+end", "pageup", "pagedown", "ctrl+a", "command+a", "ctrl+shift+n", "ctrl+shift+f", "del", "shift+del", "f2", "ctrl+enter", "command+enter", "shift+enter", "space", "enter", "ctrl+u", "command+u", "ctrl+c", "command+c", "ctrl+x", "command+x", "ctrl+v", "command+v", "ctrl+f", "command+f", "f3", "ctrl+i", "alt+i", "alt+n", "alt+m", "alt+enter", "ctrl+s", "command+s", "alt+f4"],
		function(a, b) {
	...
	return {
		...
		setTheme: function(a) {
			...
			ShareData.frameTop("Opensetting_mode",
			function(b) {
		...
		isEdit: function() {
			...
			if (a) return a = a.tagName,
			"INPUT" == a || "TEXTAREA" == a ? !0 : $(".file.file-icon-edit").length > 0 ? !0 : !1
		},
		init: function() {
			if (G.sid) {
				LocalData.get("theme") && (G.userConfig.theme = LocalData.get("theme")),
				LocalData.get("listType") && (G.userConfig.listType = LocalData.get("listType")),
				LocalData.get("listSortField") && (G.userConfig.listSortField = LocalData.get("listSortField")),
				LocalData.get("listSortOrder") && (G.userConfig.listSortOrder = LocalData.get("listSortOrder")),
...
define("app/src/explorer/fileContent", ["../../path/tpl/file/list.html"],
function(require, exports) {
	...
	lazyLoadImage = function() {
		...
		return core.isApp("desktop") ? void a.find(".lazyload-ready").each(function() {
			$(this).attr("src", $(this).attr("data-original")).hide().fadeIn(600),
		...
		function() {
			...
			if (a) {
				if ("1" == a) {
					...
					$(this).attr("src", G.staticPath + "images/file_icon/icon_file/picture_error.png"),
					$(this).data("errorReload", "2")
				}
			} else $(this).attr("src", $(this).attr("src") + "#" + UUID()),
	...
	iconFlex = function() {
		if (!core.isApp("desktop") && "icon" == G.userConfig.listType) {
			...
			for (var a = "",
			b = 0; 30 > b; b++) a += '<div class="flex-empty"></div>';
	...
	mainSetData = function(a) {
		...
		"split" == G.userConfig.listType && (b = '<div class="split-box" data-path="' + pathHashEncode(G.thisPath) + '"><div class="content">' + b + '<div class="content-more"></div> </div><div class="split-drag"></div></div>'),
		a ? $(Config.FileBoxSelector).hide().html(b).fadeIn(Config.AnimateTime).css("display", "") : $(Config.FileBoxSelector).html(b),
		"split" == G.userConfig.listType && $(".split-box").data("jsonData", G.jsonData),
		ajaxLive()
	},
	scrollDelayTimer = "",
	...
	fileIconMake = function(a, b, c) {
		...
		if (inArray(["jpg", "jpeg", "png", "bmp", "gif", "ico", "svg", "cur", "webp"], e)) {
			...
			return G.sid && (g = G.appHost + "share/image&user=" + G.user + "&sid=" + G.sid),
			g += "&time=" + strtotime(c.mtime) + "&path=",
			"<div class='picture ico' filetype='" + e + "'><img class='lazyload-ready' data-original='" + g + htmlEncode(urlEncode(c.path)) + "' draggable='false' ondragstart='return false;'/></div>"
		}
		if ("app_link" == c.type) {
		...
		if (c.icon && "oexe" == e) {
			var j = c.icon;
			return "string" == $.type(c.icon) && -1 == c.icon.search(G.staticPath) && "http" != c.icon.substring(0, 4) && (j = G.staticPath + "images/file_icon/icon_app/" + c.icon),
	...
	pathChildrenSplit = function(a, b) {
		...
		if (1 == d.length) return d.nextAll().remove(),
	...
	pathSplitCreate = function(a, b, c) {
		...
		function(d) {
			...
			if (e = htmlListAction(d, e, !0), c) if (c.nextAll(".split-box").length > 0) {
				...
				f.attr("data-path", pathHashEncode(a)).find(".content").html(e),
				f.nextAll().remove()
			} else e = '<div class="split-box" data-path="' + pathHashEncode(a) + '"><div class="content">' + e + '<div class="content-more"></div></div><div class="split-drag"></div></div>',
			$(e).insertAfter(c).data("jsonData", d);
			else e = '<div class="split-box" data-path="' + pathHashEncode(a) + '"><div class="content">' + e + '<div class="content-more"></div></div><div class="split-drag"></div></div>',
			$(e).appendTo(".bodymain .file-list-split").data("jsonData", d);
			ajaxLive(),
			"function" == typeof b && b()
		})
	},
	...
	f5Before = function() {
		if (! ("icon" == G.userConfig.listType || beforeListOpenArr.length > 0)) if (beforeListOpenArr = {},
		beforeListOpen = {},
		"list" == G.userConfig.listType) {
			...
			a.each(function() {
				...
				beforeListOpen[c] = !1;
				for (var d = [c]; 0 != a.parents(".children-list").length;) a = a.parents(".children-list"),
			...
			beforeListSplitSelect = ui.fileLight.path($(".file-list-split .split-box.split-select")),
			$(".bodymain .file-continer .split-box").each(function() {
				var a = ui.fileLight.path($(this));
				"" != a && (b[a] = {},
				b = b[a], beforeListOpen[a] = !1)
			})
		}
	},
	f5After = function(a) {
	...
	f5AfterReload = function(a, b) {
		...
		function(a, c) {
			...
			function() {
				beforeListOpen[a] = !0,
				0 != Object.keys(c).length ? f5AfterReload(c, b) : f5AfterReloadFinished(b)
			})
		}),
	...
	f5 = function(a, b, c) {
		if (void 0 == a && (a = !0), void 0 == b && (b = !1), jsonDataSortTitle(), f5Before(), beforeSelectFileArr = ui.fileLight.getAllName(), a ? pathGet(G.thisPath,
		function(a) {
			G.jsonData = a,
			mainSetData(b),
			...
			resetTotalHeight(),
			f5After(c),
			core.isApp("desktop") ? checkRecycle() : ui.headerAddress.addressSet()
		},
		function() {
	...
	jsonDataSort = function(a) {
		...
		return b = a.folderList.length > c ? sortSimple: sortFull,
	...
	pathGet = function(a, b, c) {
		...
		G.user && (d = G.appHost + "share/pathList&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode(a)),
		$.ajax({
			url: d,
			dataType: "json",
			beforeSend: function() {
			...
			success: function(a) {
				if ($(".tools-left .msg").fadeOut(300), !a || !a.code) return Tips.tips(a),
				"function" == typeof c && c(),
				!1;
	...
	jsonDatafilter = function(a) {
		...
		for (var b in a) if ("fileList" == b || "folderList" == b) for (var c = 0; c < a[b].length; c++) {
			...
			if (d.mtime && d.mtime.toString().length <= 11) if (d.atime = date(LNG.time_type, d.atime), d.ctime = date(LNG.time_type, d.ctime), a.info && a.info.pathType == G.KOD_USER_SHARE && -1 == trim(a.thisPath, "/").indexOf("/")) {
				...
				g += LNG.share_view_num + e + "  " + LNG.share_download_num + f,
				d.mtime = g
			} else d.mtime = date(LNG.time_type, d.mtime);
			d.showName && (d.name = d.showName),
			d.name = htmlEncode(d.name),
			d.sid && "file" == d.type && (d.ext = htmlEncode(core.pathExt(d.path))),
			pathIsShare(d.path) ? d.metaInfo = "path-self-share": pathIsFav(d.path) && (d.metaInfo = "tree-fav"),
			"number" == typeof d.isReadable && 0 == d.isReadable ? d.mode = "[" + LNG.not_read + "] " + d.mode: "number" == typeof d.isWriteable && 1 == d.isWriteable ? d.mode = "[" + LNG.system_role_write + "] " + d.mode: "number" == typeof d.isReadable && 1 == d.isReadable && (d.mode = "[" + LNG.only_read + "] " + d.mode),
			a.info && a.info.pathType == G.KOD_USER_RECYCLE && (d.menuType = "menu-recycle-path")
		}
		return a.filterSuccess = !0,
		a
	},
	jsonDataSortTitle = function() {
		var up = '<i class="font-icon icon-chevron-up"></i>',
		down = '<i class="font-icon icon-chevron-down"></i>';
		$("#main-title .this").toggleClass("this").attr("id", "").find("span").html(""),
		$("#main-title div[field=" + G.userConfig.listSortField + "]").addClass("this").attr("id", G.userConfig.listSortOrder).find("span").html(eval(G.userConfig.listSortOrder))
	},
	...
	checkRecycle = function() {
		$.ajax({
			...
			success: function(a) {
				...
				0 == a.data.folderList.length && 0 == a.data.fileList.length && (b = core.icon("recycle")),
	...
	currentPathMenu = function(a) {
		...
		if ("notExists" == c && ($(".path-tips span").html(LNG.not_exists), $(".path-tips").show()), $(".role-label-box").html(""), d == G.KOD_GROUP_SHARE) {
			...
			$(".role-label-box").html(m)
		} (d == G.KOD_GROUP_ROOT_ALL || d == G.KOD_GROUP_ROOT_SELF || d == G.KOD_USER_FAV || d == G.KOD_GROUP_SHARE) && $(".path-tips").hide(),
		1 == G.isRoot && b.adminRealPath ? $(".admin-real-path").removeClass("hidden") : $(".admin-real-path").addClass("hidden")
	};
	return {
		f5: f5,
		...
		init: function() {
			...
			function() {
				resetTotalHeight(),
				core.isApp("desktop") ? ui.resetDesktopIcon() : ui.headerAddress.resetWidth()
			}),
			bindScrollLoadMore()
		}
	}
...
function(a, b) {
	...
	e = function() {
		var a;
		a = "split" != G.userConfig.listType ? $(".bodymain .file-continer .file") : $(".bodymain .file-continer .split-select .file"),
		d = a,
		p("clear"),
	...
	l = function(a) {
		...
		a.removeClass("menu-file menu-folder").addClass("menu-more"),
		p()
	},
	m = function(a) {
		var b = {
...
function(a, b) {
	...
	g = function() {
		...
		function(a) {
			...
			function(a) {
				...
				if ($(this).focus(), $.contextMenu.hidden(), $(a.target).parents(".children-more").exists()) return ui.fileContent.pathChildrenTree($(this)),
				stopPP(a),
				!1;
				...
				if (!$(a.target).hasClass("item-select") && !$(a.target).parent().hasClass("item-select")) {
					if (! (a.ctrlKey || a.metaKey || a.shiftKey || $(this).hasClass(Config.SelectClassName))) return ui.fileLight.clear(),
			...
			function(a) {
				return $(".file-select-drag-temp").removeClass("file-select-drag-temp"),
				!0
			})
		}).die("mouseleave").live("mouseleave",
		function() {
	...
	k = function() {
		var a;
		$("#folder-list-tree a").die("mouseenter").live("mouseenter",
		function(b) {
			if (e) {
				...
				a = !1;
				var f = ui.tree.zTree(),
				g = f.getNodeByTId($(this).parent().attr("id")); ! g.open && g.isParent && (a = setTimeout(function() {
					f.expandNode(g, !0)
				},
				h))
			}
	...
	l = function() {
		...
		function(b) {
			...
			h))
		}).die("mouseup mouseleave").live("mouseup mouseleave",
		function() {
	...
	m = function() {
		var a = function(a, b, c) {
			if (e && "list" == G.userConfig.listType) {
				...
				if (b) {
					...
					$("." + d).not(a).removeClass(d),
					a.addClass(d),
					a.prev().hasClass("file") && a.prev().addClass("file-select-over-temp")
				} else a.removeClass(d)
			}
		};
		$(".menu-body-main").bind("mouseover",
		function(b) {
			a($(this), !0, b)
		...
		$(".children-list").die("mouseover").live("mouseover",
		function(b) {
			a($(this), !0, b),
			stopPP(b)
		}).die("mouseup mouseleave").live("mouseup mouseleave",
	...
	o = function(a) {
		if ("split" == G.userConfig.listType && n(a)) {
			...
			ui.fileContent.pathChildrenSplit(b,
			function() {
				q(b)
			})
		}
	...
	p = function() {
		...
		function(a) {
			var b = $(a.target).parents(".file"); (0 == b.length || 0 == b.find(".children-open").length) && q(ui.fileLight.path($(this)))
		})
	},
	q = function(a) {
		...
		f && a && (ui.fileContent.pathTypeChange(f), G.thisPath = a, G.jsonData = f, ui.headerAddress.addressSet()),
		ui.fileLight.init()
	},
	r = function(a) {
	...
	s = function(a) {
		$("body").removeClass("cursor-mouse cursor-warning cursor-move cursor-down cursor-add"),
	...
	t = function() {
		...
		x = function(a) {
			...
			c = function(a, b) {
				...
				void 0 != b && 0 !== b.search(G.KOD_GROUP_PATH) && 0 !== b.search(G.KOD_USER_RECYCLE) && core.isSystemPath(b) && (a = "clear");
				...
				C(b) || (e.copyTo = '<i class="font-icon bg-ok icon-copy"></i><b>' + LNG.clone + "</b>"),
			...
			if ($(".curDropToPath").exists()) d = $(".curDropToPath").attr("data-path");
				...
				d = g.path
			} else if ($(".file-select-drag-temp").exists()) d = ui.fileLight.path($(".file-select-drag-temp")),
			$(".file-select-drag-temp").hasClass("menu-recycle-button") && (e = "remove");
			...
			e && !b || (e = b ? "copyTo": C(d) ? "moveTo": "clear"),
			c(e, d)
		},
		y = function(a) {
			if (!e) return ! 1;
			if (clearTimeout(q), clearTimeout(c), e = !1, k = !1, $("body").removeClass(p), h) {
				h.addClass("animated-300").addClass("flipOutXLine").fadeOut(200,
				function() {
					h.remove(),
					h = !1
				}),
		...
		z = function() {
			...
			$('<div class="file draggable-dragging"><div class="drag-number">' + a + '</div><span><i class="font-icon bg-default icon-ok"></i>' + a + " " + LNG.file + "</span></div>").appendTo("body"),
			k = !0,
			setTimeout(J, 20),
			B()
		},
		...
		J = function() {
			...
			$("<div class='file-continer file-draging-box " + b + "'><div class='" + b + " file-draging'></div></div>").appendTo("body"),
			t = $(Config.SelectClass).filter("[data-path!='']");
			var c = t.clone(); (t.length >= I || $.browser.msie) && (c = i.clone()),
			...
			c.each(function(a) {
				...
				$(this).attr("data-path") == i.attr("data-path") && $(this).addClass("handle_target"),
				1 == c.length && ($(this).data({
					"data-animateTime": 0
				}), H = 0)
			}),
	...
	u = function() {
		...
		var l = $("." + k);
		l.die("mousedown").live("mousedown",
		function(a) {
			if (! ($(a.target).hasClass(k) && $(document).width() - a.pageX < 20)) {
				...
				$(document).unbind("mousemove").mousemove(function(a) {
					n(a)
				}),
				$(document).one("mouseup",
				function(a) {
		...
		var m = function(e) {
			...
			"split" == G.userConfig.listType && (f += $(e.target).parents(".split-box").scrollTop()),
			$(e.target).parent().hasClass(Config.FileBoxClassName) || $(e.target).parent().parent().hasClass(Config.FileBoxClassName) || $(e.target).hasClass("fix") || ($.contextMenu.hidden(), e.ctrlKey || e.metaKey || e.shiftKey || ui.fileLight.clear(), $(e.target).hasClass("ico") || (a = e.pageX - g, b = e.pageY - f, j = setTimeout(function() {
				d = !0,
				0 == $(".select-container").length && $('<div class="select-container"></div>').appendTo(Config.FileBoxSelector),
				c = $(".select-container")
			},
			100)))
		},
				...
				if ("split" == G.userConfig.listType && (k += i.parents(".split-box")[0].offsetLeft, n = k + i.width()), Math.abs(a + d - (k + n)) < d - a + n - k && Math.abs(b + e - (m + o)) < e - b + o - m) {
					if (!i.hasClass("file-select-drag-temp")) {
						...
						if (i.hasClass(Config.SelectClassName)) {
							i.removeClass(Config.SelectClassName).addClass("selectToggleClass"),
							ui.fileLight.resumeMenu(i);
							continue
						}
						i.addClass("file-select-drag-temp")
					}
				} else i.removeClass("file-select-drag-temp"),
				i.hasClass("selectToggleClass") && i.addClass(Config.SelectClassName).removeClass("selectToggleClass")
			}
		},
		q = function(e) {
	...
	C = function(a) {
		...
		switch (a) {
		case "left":
			if ("list" == G.userConfig.listType) if (1 == b.find(".children-more-cert.cert-open").length) b.find(".children-more-cert").removeClass("cert-open"),
...
define("app/src/explorer/options", [],
function(a, b) {
	var c = function() {
	...
	d = function() {
		"0" == lodash.get(window, "G.userConfig.imageThumb") && Hook.bind("explorer.list.fileThumb",
		function(a, b) {
